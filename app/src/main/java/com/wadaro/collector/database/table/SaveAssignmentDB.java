...
public class SaveAssignmentDB extends MasterDB {
    ...
    public static final String OTHER      = "otherdata";
    ...
    @Override
    protected SaveAssignmentDB build(Cursor res) {
        SaveAssignmentDB boking = new SaveAssignmentDB();
        ...
        boking.otherData    = res.getString(res.getColumnIndex(OTHER));
        return boking;
    }
    ...
    protected void buildSingle(Cursor res) {
        ...
        this.images    = res.getString(res.getColumnIndex(OTHER));
        this.otherData    = res.getString(res.getColumnIndex(IMAGES));
    }
    ...
    public ContentValues createContentValues(){
        ...
        contentValues.put(OTHER, otherData);
    ...
    public ArrayList<SaveAssignmentDB> getData(Context context){
        ArrayList<SaveAssignmentDB> data = new ArrayList<>();

...
public class DeliveryAdapter extends RecyclerView.Adapter<DeliveryAdapter.AdapterView> {
    private static final String TAG = "SurveyAdapter";

    private ArrayList<Assignment> mList;
    private Context mContext;

    public DeliveryAdapter(Context context, ArrayList<Assignment> data){
        mList = data;
        mContext = context;
    }
    @NonNull
    ...
    public Assignment getData(int position){
    ...
    public void onBindViewHolder(@NonNull AdapterView holder, int position) {
        final Assignment data = mList.get(position);
        holder.txvw_nottb_00.setText(data.noTTB);
    ...
    static class AdapterView extends RecyclerView.ViewHolder{
        TextView txvw_nottb_00, txvw_coordinator_00, txvw_installment_00,txvw_total_00;
    ...
    public interface OnSelectedListener{
        void onSelected(Assignment data);
    }
}

...
public class DownloadDialog extends Dialog {
    ...
    private final TaskView task_assignment_00,task_assgmntdtl_00,task_consumen_00;
    ...
    private final String[] task = {"Data Assignment","Detail Assignment","Detail Konsumen"};
    public DownloadDialog(@NonNull Context context) {
        ...
        task_consumen_00 = view.findViewById(R.id.task_consumen_00);
        task_consumen_00.create("3. "+ task[2]);
    ...
    public void setCompleteStep(int step){
        ...
        switch (step){
            ...
            case 1:task_assgmntdtl_00.setSuccess();
                break;
            case 2:task_consumen_00.setSuccess();
    ...
    public void setErrorStep(int step){
        switch (step){
            ...
            case 2:task_consumen_00.setFailed(); break;
        }
        bbtn_close_00.setVisibility(View.VISIBLE);
    }
